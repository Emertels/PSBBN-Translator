...
function Show-StandaloneMenu {
    while ($true) {
        ...
        Write-Host ("  {0} {1}" -f $ui.SourceFile, "Changelog_Main\input\changelog_main_eng.txt") -ForegroundColor DarkGray
        Write-Host "----------------------------------------------------------------------------------------" -ForegroundColor DarkGray
        ...
        if ($choice -eq "A" -or $choice -eq "a") {
            foreach ($langObj in $Languages40) {
                Invoke-ModuleChangelogMain $langObj -noWait $true
            }
            Write-Host ""
            Write-Host "  ========================================================================================" -ForegroundColor Green
        ...
        if ($selectedList.Count -gt 0) {
            ...
            for ($idx = 0; $idx -lt $selectedList.Count; $idx++) {
                ...
                Invoke-ModuleChangelogMain $item -noWait $noWaitFlag
            }
            continue
        } else {
            Write-Host ""

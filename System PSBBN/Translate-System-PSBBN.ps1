        ...
        if ("system" -eq "launcher") {
            ...
            for ($idx = 0; $idx -lt $selectedList.Count; $idx++) {
                ...
                switch ("system") {
                    ...
                    "changelog_main"  { Invoke-ModuleChangelogMain $item -noWait $noWaitFlag }
...
function Show-StandaloneMenu {
    while ($true) {
        ...
        Write-Host ("  {0} {1}" -f $ui.SourceFile, "System PSBBN\input\PSBBN-translation-pack-v3.5\PSBBN_English") -ForegroundColor DarkGray
        Write-Host "----------------------------------------------------------------------------------------" -ForegroundColor DarkGray
        ...
        if ($choice -eq "A" -or $choice -eq "a") {
            foreach ($langObj in $Languages40) {
                Invoke-ModuleSystemPsbbn $langObj -noWait $true
            }
            Write-Host ""
            Write-Host "  ========================================================================================" -ForegroundColor Green
        ...
        if ($selectedList.Count -gt 0) {
            ...
            for ($idx = 0; $idx -lt $selectedList.Count; $idx++) {
                ...
                Invoke-ModuleSystemPsbbn $item -noWait $noWaitFlag
            }
            continue
        } else {
            Write-Host ""
